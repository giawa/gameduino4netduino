...
namespace Walk
{
    ...
    {
        private static ushort[] a = new ushort[256];
        private static byte WALK_HANDLE = 0;
        ...
        public static void Main()
        {
            ...
            while (true)
            {
                GD2.ClearColorRGB(0x000050);
                GD2.Clear();
                GD2.Begin(GD2.Primitive.Bitmaps);

                for (ushort i = 0; i < 256; i++)
                {
                    GD2.ColorRGB((byte)i, (byte)i, (byte)i);
                    GD2.Vertex2ii(a[i], i, WALK_HANDLE, (byte)((a[i] >> 2) & 7));
                    a[i] = (ushort)((a[i] + 1) & 511);
                }
        ...
        private static readonly byte[] walk = new byte[] { 
